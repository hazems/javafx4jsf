 ...
 */
package com.googlecode.javafx4jsf.jsfplugin.mojo;
...
import com.googlecode.javafx4jsf.jsfplugin.digester.Attribute;
import com.googlecode.javafx4jsf.jsfplugin.digester.Component;
import com.googlecode.javafx4jsf.jsfplugin.util.FacesMojoUtils;
...
public class TagMojo extends BaseFacesMojo {
	...
	private void writePackageImportAndClassDefinition(BufferedWriter writer, Component component, String tagClassName) throws IOException {
		writer.write("package com.googlecode.javafx4jsf.component." + component.getParentPackagePath() + ";\n");
		writer.write("\n");

		writer.write("import javax.faces.webapp.UIComponentTag;\n");
		writer.write("import javax.faces.component.UIComponent;\n");
		writer.write("import com.googlecode.javafx4jsf.util.ComponentUtils;\n");
		writer.write("\n");
